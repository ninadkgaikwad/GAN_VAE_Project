...
GAN - with CNNs [Large Model] using Keras+TensorFlow
...
def make_generator_model():
    ...
    model.add(layers.Dense(7*7*128, input_shape=(noise_dim,)))
    ...
    # model.add(layers.Conv2DTranspose(64, (7, 7), strides=(1, 1), padding='same'))
    # assert model.output_shape == (None, 7, 7, 64)
    # model.add(layers.BatchNormalization())
    # model.add(layers.LeakyReLU())
    
    model.add(layers.Conv2DTranspose(32, (7, 7), strides=(1, 1), padding='same'))
