...
VAE - with CNNS using Keras+TensorFlow
  ...
  def __init__(self, latent_dim):
    ...
    self.encoder = tf.keras.Sequential(
        [
            ...
            tf.keras.layers.Conv2D(filters=64, kernel_size=5, strides=2, activation='relu'), 
    ...
    self.decoder = tf.keras.Sequential(
        [
            ...
            tf.keras.layers.Conv2DTranspose(filters=32, kernel_size=5, strides=1, padding='same', activation='relu'),
            tf.keras.layers.Conv2DTranspose(filters=16, kernel_size=5, strides=2, padding='same', activation='relu'),
            # No activation
